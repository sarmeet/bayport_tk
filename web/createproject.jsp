    ...
    <div class="col-xs-8
        ...
        <div class="box left-text">
            ...
            <form class="ui form" action="project" method="post">
                <div class="two fields left-text">
                    <div class="field">
                        <label>Name</label>
                        <input type="text" name="projectname" placeholder="The Big project">
                    </div>

                    <div class="field">
                        <label>Owner</label>
                        <input type="text" name="projectownername" placeholder="Name of project owner">
                    </div>
                </div>
                ...
                <div class="three fields">
                    ...
                    <div class="field">
                        <label>State </label>
                        <select class="ui search selection dropdown" name="state" id="states">
                ...
                <div class="two fields">
                    ...
                    <div class="field">
                        <div class="field">
                            <label>CMU</label>
                            <input type="text" name="cmu" placeholder="Number of CMU...">
                        </div>
                    ...
                    <div class="field">
                        <div class="field">
                            <label>Price</label>
                            <input type="number" name="cmuprice" placeholder="Total price of CMU...">
                        </div>
                    </div>
                </div>
                ...
                <div class="two fields">
                    ...
                    <div class="field">
                        <div class="field">
                            <label>Bricks</label>
                            <input type="text" name="bricks" placeholder="Number of bricks...">
                        </div>
                    </div>
                    <div class="field">
                        <div class="field">
                            <label>Price</label>
                            <input type="number" name="bricksprice" placeholder="Total price of bricks...">
                        </div>
                    </div>
                </div>
                <div class="two fields">
                    <div class="field">
                        <div class="field">
                            <label>Stucco/Stone</label>
                            <input type="number" name="stucco" placeholder="Number of stones...">
                        </div>
                    </div>
                    <div class="field">
                        <div class="field">
                            <label>Price</label>
                            <input type="number" name="stuccoprice" placeholder="Total price of Stucco/Stone...">
                        </div>
                    </div>
                </div>
                ...
                <div class="two fields">
                    <div class="field">
                        <div class="field">
                            ...
                            <input type="text" name="scaffolding" placeholder="Number of scafolds...">
                        </div>
                    </div>
                    <div class="field">
                        <div class="field">
                            <label>Price</label>
                            <input type="number" name="scaffoldingprice" placeholder="Total price of Stucco/Stone...">
                        </div>
                    </div>
                </div>
