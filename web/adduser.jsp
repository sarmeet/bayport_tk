    ...
    <div class="col-xs-8
        ...
        <div class="box">
            ...
            <div class="left-text">
                ...
                <h4><i class="user icon"></i>
                    Name</h4>
                <form class="ui form" method="post" action="${pageContext.request.contextPath}employee">
                    ...
                    <div class="three fields">
                        ...
                        <div class="field">
                            ...
                            <select name="jobtitle" class="ui dropdown" id="jobtitle">
                    ...
                    <h4><i class="at icon"></i>
                        Contact</h4>
                    <div class="fields">
                        <div class="field">
                            <label>Phone Number</label>
                            <div class="ui left icon input">
                                <input type="text" name="phonenumber" placeholder="111-222-3333...">
                        ...
                        <div class="field">
                            ...
                            <div class="ui left icon input">
                                <input type="text" name="email" placeholder="hi@mail.com...">
                        ...
                        <tr>
                            <td class="collapsing">
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="sunday[working]"> <label></label>
                                </div>
                            </td>
                            <td>Sunday</td>
                            <td><input type="time" name="sunday[starttime]"></td>
                            <td><input type="time" name="sunday[endtime]"></td>
                            <td>
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="sunday[overtime]"> <label></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="collapsing">
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="monday[working]"> <label></label>
                                </div>
                            </td>
                            <td>Monday</td>
                            <td><input type="time" name="monday[starttime]"></td>
                            <td><input type="time" name="monday[endtime]"></td>
                            <td>
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="monday[overtime]"> <label></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="collapsing">
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="tuesday[working]"> <label></label>
                                </div>
                            </td>
                            <td>Tuesday</td>
                            <td><input type="time" name="tuesday[starttime]"></td>
                            <td><input type="time" name="tuesday[endtime]"></td>
                            <td>
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="tuesday[overtime]"> <label></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="collapsing">
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="wednesday[working]"> <label></label>
                                </div>
                            </td>
                            <td>Wednesday</td>
                            <td><input type="time" name="wednesday[starttime]"></td>
                            <td><input type="time" name="wednesday[endtime]"></td>
                            <td>
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="wednesday[overtime]"> <label></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="collapsing">
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="thursday[working]"> <label></label>
                                </div>
                            </td>
                            <td>Thursday</td>
                            <td><input type="time" name="thursday[starttime]"></td>
                            <td><input type="time" name="thursday[endtime]"></td>
                            <td>
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="thursday[overtime]"> <label></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="collapsing">
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="friday[working]"> <label></label>
                                </div>
                            </td>
                            <td>Friday</td>
                            <td><input type="time" name="friday[starttime]"></td>
                            <td><input type="time" name="friday[endtime]"></td>
                            <td>
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="friday[overtime]"> <label></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="collapsing">
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="saturday[working]"> <label></label>
                                </div>
                            </td>
                            <td>Saturday</td>
                            <td><input type="time" name="saturday[starttime]"></td>
                            <td><input type="time" name="saturday[endtime]"></td>
                            <td>
                                <div class="ui fitted slider checkbox">
                                    <input type="checkbox" name="saturday[overtime]"> <label></label>
                                </div>
                            </td>
                        </tr>
                        </tbody>
                    ...
                    <h4><i class="mail icon"></i>
                        Address</h4>
                    <div class="field">
                        <label>First Line</label>
                        <input type="text" name="firstline" placeholder="First line...">
                    </div>
                    <div class="field">
                        <label>Second Line</label>
                        <input type="text" name="secondline" placeholder="Second Line...">
                    </div>
                    <div class="three fields">
                        <div class="field">
                            <label>City</label>
                        ...
                        <div class="field">
                            <label>State </label>
                            <select class="ui dropdown" name="state" id="states">
                    ...
                    <h4><i class="lock icon"></i>Authentication Settings &nbsp;&nbsp

                        <div class="ui slider checkbox">
                            <input type="checkbox" name="enableauthentication" tabindex="0">
                    ...
                    <div class="three fields ">
                        <div class="field">
                            ...
                            <input type="text" name="username" placeholder="user007...">
                        </div>
                        <div class="field">
                    ...
                    <br/>
                    <div class="center-sm center-xs center-lg center-md">
